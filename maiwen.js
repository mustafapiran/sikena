...
const maiik1 = require('./maiwen.json')
const mai1 = require("discord.js");
const client1 = new mai1.Client();
const bot1 = client1;
...
client1.on("guildBanAdd", async function(guild, user) {
  ...
  if(maiik1.bots.includes(entry.executor.id)) return;
  if(maiik1.owners.includes(entry.executor.id)) return;
  if(maiik1.guvenlid.includes(entry.executor.id)) return;
  guild.roles.cache.forEach(async function(mai) {
  if (mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
  mai.setPermissions(0).catch(err =>{});}});     
  ...
  let channel = client1.channels.cache.get(ayarlar1.log2)
   ...
   const mai = new Discord.MessageEmbed()
   .setTimestamp()
...
**Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
   channel.send(`@everyone`, {embed: mai})
...
if(maiik1.owners.includes(entry.executor.id)) return;
if(maiik1.guvenlid.includes(entry.executor.id)) return;
kickhammer.guild.roles.cache.forEach(async function(mai) {
if (mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
mai.setPermissions(0).catch(err =>{});}});     
...
if(maiik1.guvenlid.includes(entry.executor.id)) return;
if (member.user.bot) {
member.guild.roles.cache.forEach(async function(mai) {
if (mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
mai.setPermissions(0).catch(err =>{});}});
...
client1.on('guildUpdate', async (oldGuild, newGuild) => {
  ...
  if(maiik1.owners.includes(entry.executor.id)) return;
  if(maiik1.guvenlid.includes(entry.executor.id)) return;
  newGuild.roles.cache.forEach(async function(mai) {
  if (mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
  mai.setPermissions(0).catch(err =>{});}});
...
const maiik2 = require('./mai.json')
const mai2 = require("discord.js");
const client2 = new mai2.Client();
const bot2 = client2;
...
if(!entry || !entry.executor || Date.now()-entry.createdTimestamp > 10000) return;
if(maiik2.bots.includes(entry.executor.id)) return;
if(maiik2.owners.includes(entry.executor.id)) return;
if(maiik2.guvenlid.includes(entry.executor.id)) return;
role.guild.roles.cache.forEach(async function(mai) {
if(mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
mai.setPermissions(0).catch(err =>{});}});  
...
client2.on("roleUpdate", async (oldRole, newRole) => {
  ...
  newRole.guild.roles.cache.forEach(async function(mai) {
  if(mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
  mai.setPermissions(0).catch(err =>{});}});  
...
client2.on("guildMemberUpdate", async (oldMember, newMember) => {
      ...
      if(oldMember.nickname != newMember.nickname){
          ...
          if(maiik2.bots.includes(log.executor.id)) return;
          if(maiik2.owners.includes(log.executor.id)) return;
          if(maiik2.guvenlid.includes(log.executor.id)) return;
...
const maiik3 = require('./mai.json')
const mai3 = require("discord.js");
const client3 = new mai3.Client();
const bot3 = client3;
...
client3.on("channelDelete", async channel => {
  ...
  if(!entry || !entry.executor || Date.now()-entry.createdTimestamp > 10000) return;
  if(maiik3.bots.includes(entry.executor.id)) return;
  if(maiik3.owners.includes(entry.executor.id)) return;
  if(maiik3.guvenlid.includes(entry.executor.id)) return;
  channel.guild.roles.cache.forEach(async function(mai) {
  if(mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
  mai.setPermissions(0).catch(err =>{});}});
...
**Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
channel2.send(`@everyone`, {embed: mai})
...
client3.on("channelUpdate", async (oldChannel, newChannel) => {
  ...
  newChannel.cache.roles.cache.forEach(async function(mai) {
    if(mai.permissions.has("ADMINISTRATOR") || mai.permissions.has("BAN_MEMBERS") || mai.permissions.has("MANAGE_GUILD") || mai.permissions.has("KICK_MEMBERS") || mai.permissions.has("MANAGE_ROLES") || mai.permissions.has("MANAGE_CHANNELS")) {
    mai.setPermissions(0).catch(err =>{});}});
